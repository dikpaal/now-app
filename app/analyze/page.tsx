                                ...
                                <div className="space-y-4">
                                    <div className="relative">
                                        <button
                                            ...
                                            disabled={isLocked}
                                            className={`w-full flex items-center justify-between px-4 py-3 text-sm border-2 border-stone-200 rounded-xl bg-white transition-all duration-300 shadow-sm ${isLocked
                                                ...
                                                <div className="space-y-8">
                                                    ...
                                                    <div className="animate-in fade-in slide-in-from-top-4 duration-700 delay-300">
                                                        <div className="bg-stone-50 rounded-xl border border-stone-200 overflow-hidden shadow-lg">
                                                            ...
                                                            <div
                                                                className={`transition-all duration-500 ease-in-out ${isAnalysisExpanded ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"
                                                                    } overflow-hidden`}
                                                            >
